...
//
// You should have received a copy of the GNU Lesser General PubCULTY_TARGETlic License
...
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_DENOMINATOR       = 365 * 12 * 60 * 60 / DIFFICULTY_TARGET;
